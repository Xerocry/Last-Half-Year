...
%В данной работе мы познакомились с методами взаимного перехода между моделями вход-выход и вход-состояние-выход, а также с каноническими формами представления моделей вход-состояние-выход. Наглядно продемонстрировали возможность перехода между моделями ВВ и ВСВ динамических систем. Также были получены дополнительные навыки работы с пакетомSimulink.
%
%
%
