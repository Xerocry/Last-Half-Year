...
\subsection{Работа утилиты tracert}
	...
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.4]{tracert3}}
	...
	\newpage
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.6]{tracert4}}
		\caption{Второй пакет трассировки}
		\label{img:tracert_ans}
	\end{figure}

	\begin{figure}[h!]
		\center{\includegraphics[scale=0.6]{tracert5}}
...
\subsection{Протокол ICMP}
	\subsubsection{Фрагментированный ping}
		...
		\newpage
		\begin{figure}[h!]
			\center{\includegraphics[scale=0.6]{frag_ping}}
	...
	\newpage
	\begin{figure}[h!]
		\center{\includegraphics[scale=0.8]{icmp_error2}}
		\caption{ICMP-ответ}
...
\begin{figure}[h!]
	\center{\includegraphics[scale=0.8]{arpA}}
	\caption{ARP ответ}
	\label{img:arp_answ}
\end{figure}
...
\subsection{TCP-протокол}
	...
	\newpage
		...
		\newpage
		\begin{figure}[h!]
			\center{\includegraphics[scale=0.6]{tcp_syn_ack}}
		...
		\begin{figure}[h!]
			\center{\includegraphics[scale=0.6]{ack}}
	...
	\subsubsection{Разрыв соединения}
		...
		\begin{figure}[h!]
			\center{\includegraphics[scale=0.6]{tcp_reset}}
